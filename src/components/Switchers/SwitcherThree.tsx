...
const SwitcherThree: React.FC<SwitcherThreeProps> = ({ isChecked, onChange }) => {
  return (
    <div>
        ...
        <div className="relative">
          ...
          <div
            className={`dot absolute left-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-white transition ${
              isChecked && "!right-1 !translate-x-full !bg-primary dark:!bg-white"
            }`}
          >
            <span className={`hidden ${isChecked && "!block"}`}>
              <svg
