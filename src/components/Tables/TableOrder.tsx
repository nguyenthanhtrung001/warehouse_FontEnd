    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ">
      ...
      <div className="container mx-auto mb-1">
        <div className="grid grid-cols-12 gap-4 border-t border-stroke px-4 py-4.5 bg-blue-700 text-white">
          <div className="col-span-2 font-medium ml-4">Mã đơn đặt</div>
          ...
          <div className="container mx-auto px-4 mb-1 border-b border-gray-200 p-1 text-black">
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-2 flex flex-col gap-4 sm:flex-row sm:items-center ml-4" onClick={() => handleInvoiceClick(invoice)}>
                <p className="text-sm text-black dark:text-white mr-3 text-blue-800 font-bold">DH000{invoice.id}</p>
              </div>
              <div className="col-span-3">
              ...
              <div className="col-span-2">
                <p className="text-sm text-meta-3 font-bold">
                <button className="bg-green-600 text-white px-4 py-2 rounded" onClick={() => handlePayment(invoice.id)}>Thanh Toán</button>
                </p>
              </div>
            </div>
          </div>
          ...
          {selectedInvoice && selectedInvoice.id === invoice.id && (
            <div className="px-4 py-4.5 border border-blue-700 dark:border-strokedark md:px-6 2xl:px-7.5 text-xm  text-black">
              <div className="container mx-auto px-4">
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-4">
                    ...
                    <ul className="list-none p-0">
                      <li className="mb-2 border-b border-gray-300 pb-2">Mã hóa đơn: <span className="font-bold text-blue-700">DH000{selectedInvoice.id}</span></li>
                      <li className="mb-2 border-b border-gray-300 pb-2">Thời gian: 
                        <span className="font-bold">
                        {format(invoice.printDate, 'dd/MM/yyyy - HH:mm:ss')} </span></li>
                ...
                <div className="container mx-auto mt-2 border border-blue-500 bg-blue-50">
                  ...
                  {invoiceDetails.map((detail) => (
                    <div className="grid grid-cols-12 gap-4 py-2 border-b border-stroke" key={detail.productId}>
                      <div className="col-span-4 px-6 text-blue-500 font-bold">MH000{detail.productId}</div>
                ...
                <div className="grid grid-cols-12 mb-3 py-6">
                  <div className="col-span-8"></div>
                  <div className="col-span-4 px-2 font-bold flex justify-end">
                    
                  <button onClick={() => handleCancelOrder(selectedInvoice.id)} className="bg-red text-white px-4 py-2 rounded mt-4">Hủy Đơn</button>
                  </div>
                </div>
              </div>
            </div>
